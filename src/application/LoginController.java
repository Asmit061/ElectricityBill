...
public void newUser(ActionEvent event) {
	try {
		...
		Pane root = loader.load(getClass().getResource("/design/NewUser.fxml").openStream());
...
public void error(ActionEvent event) {
	try {
		...
		Stage primaryStage = new Stage();
		FXMLLoader loader = new FXMLLoader();
		Pane root = loader.load(getClass().getResource("/design/Error.fxml").openStream());
		Scene scene = new Scene(root);
		scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());
		primaryStage.setScene(scene);
		primaryStage.initStyle(StageStyle.TRANSPARENT);
    	...
    	try {
    		if(ck.checkUser(txtusername.getText(), txtpassword.getText()))
			{
				  ((Node)event.getSource()).getScene().getWindow().hide();
				   Stage primaryStage = new Stage();
				   FXMLLoader loader = new FXMLLoader();
				   Pane root = loader.load(getClass().getResource("/design/User.fxml").openStream());
	    	...
	    	try {
	    		if(ck.checkAdmin(txtusername.getText(), txtpassword.getText()))
				{
					  ((Node)event.getSource()).getScene().getWindow().hide();
					   Stage primaryStage = new Stage();
					   FXMLLoader loader = new FXMLLoader();
					   Pane root = loader.load(getClass().getResource("/design/Admin.fxml").openStream());
